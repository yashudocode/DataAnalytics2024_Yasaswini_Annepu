#ISLR : Intoduction to statistical learning with R 
...
#validation set. Note that the -train selects only the observations that are not in the training set.
attach(Auto)
...
#If we choose different training set instead, then we will obtain somewhat diffferent errors,
